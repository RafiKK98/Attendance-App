...
public class DbHelper extends SQLiteOpenHelper {
    ...
    long updateStatus(long sid,String date, String status){
        ...
        String where = DATE_KEY + "='"+ date+"' AND "+ S_ID+"="+sid;

        return database.update(STATUS_TABLE_NAME,values,where, null);
    }
    ...
    String getStatus(long sid, String date){
        ...
        SQLiteDatabase database = this.getReadableDatabase();
        String where = DATE_KEY + "='"+ date+"' AND "+ S_ID+"="+sid;
        Cursor cursor = database.query(STATUS_TABLE_NAME,null,where,null,null,null,null);
